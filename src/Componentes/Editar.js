            ...
            <div className="card w-50 m-auto bg-dark mt-4 mb-4 border-white">
                ...
                <form className="card-body">
                    <div className="form-group">
                        <input type="text" placeholder="Nombre Articulo" name="nombre" onChange={this.cambio} className="form-control" id="titulo"/>   
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <input type="number" placeholder="Numero" name="numero" className="form-control mt-3" onChange={this.cambio} id="numero"/>   
                    </div>
                    <div className="form-group">
